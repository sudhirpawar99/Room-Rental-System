...
<%
		...
		PreparedStatement pst = con.prepareStatement("Select name,ap,city,locality,size,fu,price from onsel where city=? and locality=? and size=? and fu=? and price=?;");
	...
	<td><a href="https://www.spoctree.com/campaign/home-loan/sbi/?utm_source=Google&utm_medium=Search&utm_term=sbi%20home%20loan&utm_content=SBI-Home-Loan&utm_campaign=HL_S_Brand+Product_EP">APPLY HERE</a></td>
	<td><a href="https://portal.hdfc.com/campaign/new">APPLY HERE</a></td>
	</tr>
        <%
